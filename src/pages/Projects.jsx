...
const Projects = () => {
  ...
  return (
    <section id="projects" className="mb-12">
      ...
      <div class="overflow-x-auto md:py-5 px-5">
      <div className="inline-flex mx-5 gap-x-10 place-content-center scroll-auto snap-x snap-normal snap-proximity md:pl-40">
