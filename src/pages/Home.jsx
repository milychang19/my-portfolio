...
const Home = () => {
  return (
    <section id="home">
      ...
      <a href={resume} title="Resume" target="_blank" rel="noreferrer"><button className="bg-green text-yellow font-bold p-1.5 w-44 rounded-xl shadow-lg transition-color hover:bg-forest relative top-[-30px] animate-fade-in-zoom4">Resume</button></a>
    </section>
  );
};
